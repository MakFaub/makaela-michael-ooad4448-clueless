...
/*
    ...
    Classes generated by Claude were not necessary for project requirements, and were used to enhance
    game experience and debugging, so that we did not have to use just BoardInfoDisplay to play the game

    Helped Organize a Usable Command Line Board

    Prompt: Information to be displayed by the board should be kept a cell that represents the space visually.
    The cell should contain indicators for weapon, artifact, players (with player numbers for shorter display),
    and a placeholder indicator for when a space is empty.
